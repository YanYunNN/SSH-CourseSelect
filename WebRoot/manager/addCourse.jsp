...
<body>
	<table width="90%" align="center" cellspacing="0">
		...
		<tr>
			...
			<td width="663" height="20"><html:form
					action="/course.do?method=insert">
					<table cellspacing="1" bgcolor="#c2d3b0">
						<tr>
							<td width="78" bgcolor="#FFFFFF" class="td0">选择专业：</td>
							<td width="355" bgcolor="#FFFFFF">&nbsp; <html:select
						...
						<tr>
							...
							<td bgcolor="#FFFFFF">&nbsp;&nbsp;<html:textarea
									property="courseInfo" rows="3" cols="50"></html:textarea></td>
