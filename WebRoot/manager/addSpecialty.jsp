...
<body>
	<table width="955px" align="center" cellspacing="0">
		...
		<tr>
			<td>&nbsp;</td>
			<td width="61">&nbsp;</td>
			<td width="605" align="left"><html:form
					action="/specialty.do?method=insert" method="post">
					<table border="0" align="center" cellpadding="0" cellspacing="1"
						bgcolor="#c2d3b0">
						<tr>
							<td width="20%" height="24" bgcolor="#FFFFFF" class="td0">
								&nbsp;入学年份：&nbsp;</td>
							<td width="43%" bgcolor="#FFFFFF">&nbsp; <html:select
									property="enterYear">
									<html:option value="2013">2013届</html:option>
									<html:option value="2014">2014届</html:option>
						...
						<tr>
							...
							<td bgcolor="#FFFFFF" class="STYLE2">&nbsp;请输入新专业名称&nbsp;</td>
						</tr>
						<tr>
							<td height="24" bgcolor="#FFFFFF" class="td0">
								&nbsp;学制：&nbsp;</td>
							<td bgcolor="#FFFFFF">&nbsp; <html:select
									property="langthYear">
									<html:option value="4">4年</html:option>
									<html:option value="5">5年</html:option>
								</html:select>
							</td>
							<td bgcolor="#FFFFFF" class="STYLE2">&nbsp;请选择新专业的学制&nbsp;</td>
						</tr>
						<tr>
