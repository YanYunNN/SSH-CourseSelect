			...
			<td colspan="2">
				<table width="700" align="center" cellspacing="0">
					...
					<tr>
						...
						<td width="189" align="left" class="td2">&nbsp;${specialty.enterYear}
							年</td>
						<td width="69" class="td1">专业名称：</td>
						<td width="127" align="left" class="td2">&nbsp;${specialty.name}</td>
						<td width="41" class="td1">学制：</td>
						<td width="195" align="left" class="td2">&nbsp;${specialty.langthYear}
							年</td>
					</tr>
				</table>
			</td>
				...
				<table width="700" align="center" cellspacing="0">
					...
					<tr>
						...
						<logic:equal name="course" value="true" property="isFinish">
							...
							<td width="100" class="td1"><html:link
									page="/course.do?method=updateIsFinish&id=${course.id}">设置为不可选</html:link>
							</td>
						</logic:equal>
					</tr>
				</table>
