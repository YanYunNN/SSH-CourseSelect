...
<body>
	<table width="955px" align="center" cellspacing="0">
		...
		<tr>
			<td width="34" height="30" valign="middle">&nbsp; <span
				class="STYLE1"><img src="images/jiantou.jpg" width="15"
					height="17" /></span></td>
		...
		<tr>
			<td>&nbsp;</td>
			<td width="80">&nbsp;</td>
			<td width="500"><html:form action="/updatePwd.do?type=m">
					<table cellspacing="1" bgcolor="#c2d3b0">
						...
						<tr>
							...
							<td width="185" bgcolor="#FFFFFF">&nbsp;<html:text
									property="loginName" value="${loginName}" readonly="true" /></td>
