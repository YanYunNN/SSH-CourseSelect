	...
	<table width="845" cellspacing="0" align="center">
		...
		<tr>
			<td width="150" height="500" align="left" valign="top"
				bgcolor="#E4F0D8"><jsp:include page="left.jsp" /></td>
			<td align="left" valign="top">
				<table cellspacing="0" width="600px" align="center">
				...
				</table> <html:form action="/stuUser.do?method=selectting">
					<table width="500" align="center" cellspacing="0">
						...
						<logic:iterate id="list" name="list">
							<tr>
								<td height="30" class="td1"><input type="checkbox"
									name="courseId" value="${list[1].id}"></td>
								<td align="center" class="td1"><html:link
										page="/stuUser.do?method=courseInfo&id=${list[1].id}&path=select">${list[1].name}</html:link></td>
