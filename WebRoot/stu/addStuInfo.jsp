...
<script type="text/javascript"> 
	...
	document.stuUserForm.stuNo.focus();
		...
		if (document.stuUserForm.birthday.value == null
				|| document.stuUserForm.birthday.value == "") {
			alert("出生日期不能为空！");
			document.stuUserForm.birthday.focus();
			return false;
		}
		if (document.stuUserForm.homeAddr.value == null
				|| document.stuUserForm.homeAddr.value == "") {
			alert("家庭住址不能为空！");
			document.stuUserForm.homeAddr.focus();
			return false;
		}
		if (document.stuUserForm.addr.value == null
				|| document.stuUserForm.addr.value == "") {
			alert("现住址不能为空！");
			document.stuUserForm.addr.focus();
			return false;
		}
		if (document.stuUserForm.tel.value == null
				|| document.stuUserForm.tel.value == "") {
			alert("联系电话不能为空！");
