...
<script type="text/javascript">
	function checkInput() {
		if (document.userLoginForm.loginName.value == null
				|| document.userLoginForm.loginName.value == "") {
			alert("用户名不能为空");
			document.userLoginForm.loginName.focus();
			return false;
		}
		if (document.userLoginForm.pwd.value == null
				|| document.userLoginForm.pwd.value == "") {
			alert("用户密码不能为空！");
			document.userLoginForm.pwd.focus();
			return false;
		}
		if (document.userLoginForm.pwd1.value == null
				|| document.userLoginForm.pwd1.value == "") {
			alert("确认密码不能为空！");
		...
		if (document.userLoginForm.mail.value == null
				|| document.userLoginForm.mail.value == "") {
			alert("电子邮箱不能为空！");
		...
		<tr>
			<td colspan="2" height="200"><html:form action="/reg.do"
					...
					<table width="600" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td height="24" colspan="3" align="center" bgcolor="#FFFFFF">
								<html:submit value="注册" />&nbsp;&nbsp;&nbsp;&nbsp;<html:reset
									value="重置" />
							</td>
						</tr>
					</table>
